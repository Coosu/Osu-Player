...
namespace Milki.OsuPlayer.Converters
{
    ...
    {
        private static Path CreatePath(string fill, string data, IBrush? fillBrush = null)
        {
            return new Path
            {
                Fill = fillBrush ?? Brush.Parse(fill),
                Data = StreamGeometry.Parse(data),
                Stretch = Stretch.Uniform
            };
        }

        private static Viewbox CreateEnabledHeart()
        {
            var canvas = new Canvas { Width = 1024, Height = 1024 };
            
            var pathLeft = CreatePath("#de4958", "M 983.384 381.465 c 0 -147.456 -119.467 -266.923 -266.923 -266.923 c -81.4649 0 -154.283 36.4089 -203.207 93.8662 c -48.9245 -57.4578 -121.856 -93.8662 -203.207 -93.8662 c -147.456 0 -266.923 119.467 -266.923 266.923 c 0 77.3689 35.6125 142.109 85.5609 195.811 L 514.275 947.964 l 378.994 -366.592 c 48.0142 -50.0622 90.112 -120.377 90.112 -199.907 Z");
            var pathRight = CreatePath("#eb5564", "M 514.275 947.964 L 128.569 577.276 C 78.507 523.574 43.008 458.835 43.008 381.465 c 0 -147.456 119.467 -266.923 266.923 -266.923 c 81.4649 0 154.283 36.4089 203.207 93.8662 l 1.13778 739.555 Z");

            pathLeft.Width = 1024;
            pathLeft.Height = 1024;
            pathRight.Width = 1024;
            pathRight.Height = 1024;

            canvas.Children.Add(pathLeft);
            canvas.Children.Add(pathRight);
        ...
        private static Viewbox CreateDisabledHeart()
        {
        ...
        public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
        {
            ...
            {
                return CreateEnabledHeart();
            }
            return CreateDisabledHeart();
        }
